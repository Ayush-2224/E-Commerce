  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleFormSubmit} className="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden">
          {/* Header */}
                    ...
                    <div className="space-y-4 pr-8">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
                          value={group.heading}
                          onChange={(e) => {
                            const updated = [...specGroups];
