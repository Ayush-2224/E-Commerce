...
function Order() {
  ...
  // Filter out orders where all products are missing (null)
  const filteredOrders = orders.filter(order =>
    Array.isArray(order.productId) && order.productId.some(product => product)
  );
        ...
        {filteredOrders.length === 0 ? (
          ...
          <div className="space-y-6">
            {filteredOrders.map((order) => (
              ...
              >
                {/* Check if productId is an array and has valid products */}
                          ...
                          <div className="flex gap-6 items-start">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-400 mb-3">
                                This product has been removed from our store
                              </p>
